INSERT INTO RATINGS (NAME) SELECT 'G'
WHERE NOT EXISTS (SELECT NAME FROM RATINGS WHERE NAME = 'G');

INSERT INTO RATINGS (NAME) SELECT 'PG'
WHERE NOT EXISTS (SELECT NAME FROM RATINGS WHERE NAME = 'PG');

INSERT INTO RATINGS (NAME) SELECT 'PG-13'
WHERE NOT EXISTS (SELECT NAME FROM RATINGS WHERE NAME = 'PG-13');

INSERT INTO RATINGS (NAME) SELECT 'R'
WHERE NOT EXISTS (SELECT NAME FROM RATINGS WHERE NAME = 'R');

INSERT INTO RATINGS (NAME) SELECT 'NC-17'
WHERE NOT EXISTS (SELECT NAME FROM RATINGS WHERE NAME = 'NC-17');
